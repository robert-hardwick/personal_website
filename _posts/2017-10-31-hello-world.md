...
<figure style="width:400px;text-align: center;" class="align-center">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/helloworld/alldigits.png" alt="">
...
<figure style="width:400px;text-align: center;" class="align-center">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/helloworld/mnist.png" alt="">
...
<figure class="quarter">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/helloworld/digits/2.jpg" alt="">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/helloworld/digits/0.jpg" alt="">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/helloworld/digits/1.jpg" alt="">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/helloworld/digits/7.jpg" alt="">
</figure>
