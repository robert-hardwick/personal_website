...
header:
  overlay_image: images/deeplearnpc/build1.jpg
  overlay_filter: 0.5
categories:
  - ml
tags:
...
<figure class="third">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/deeplearnpc/build1.jpg" alt="">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/deeplearnpc/build2.jpg" alt="">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/deeplearnpc/build3.jpg" alt="">
</figure>

<figure class="third">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/deeplearnpc/build4.jpg" alt="">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/deeplearnpc/build5.jpg" alt="">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/deeplearnpc/build6.jpg" alt="">
</figure>
...
<figure style="width:800px;text-align: center;" class="align-center">
	<img src="{{ site.url }}{{ site.baseurl }}/assets/images/cpugpu/graph.png" alt="">
